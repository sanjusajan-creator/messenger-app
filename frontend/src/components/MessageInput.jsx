...
function MessageInput() {
  ...
  return (
    <div className="p-3 sm:p-4 border-t border-slate-700/50">
      ...
      <form onSubmit={handleSendMessage} className="max-w-3xl mx-auto flex space-x-3 sm:space-x-4">
        <input
          type="text"
          value={text}
          onChange={(e) => {
          ...
          className="flex-1 bg-slate-800/50 border border-slate-700/50 rounded-lg py-2 px-3 sm:px-4 text-sm sm:text-base text-slate-100 placeholder-slate-400 caret-cyan-300"
